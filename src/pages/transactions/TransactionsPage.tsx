...
function TransactionsPage() {
  ...
  return (
    <div className="blocks-container">
      ...
      <div className="page-hero card card-lg card-black mb-3 transactions-stats" style={{ background: '#111', borderRadius: 18, boxShadow: '0 2px 12px #0006', padding: 0, overflow: 'hidden', border: 'none' }}>
